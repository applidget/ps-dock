...
var Handler = function(args){
  ...
  var handler = this;
  var settings = this.searchConfigFiles(this.options, this.parseConfigFile);
}
...
Handler.prototype.searchConfigFiles = function(options, callback) {
  ...
  try{
    ...
    if(stat.isFile()){
      return new Properties ().load (process.cwd() + '/.psdockrc', function (){
    ...
    try {
      ...
      if(stat.isFile()){
        return new Properties ().load (process.env["HOME"] + '/.psdockrc', function (){
