...
exports.createTcpLogger  = function(options){
...
TcpLogger.prototype.connectStreamToSocket = function (context){
  ...
  tcpLogger.on('end', function(){
    tcpLogger.write('Connexion will be closed')
    try {
...
TcpLogger.prototype.connect = function(){
  var tcpLogger = this;
  try{
    tcpLogger.sockRemoteShell = tls.connect(tcpLogger.port, tcpLogger.host, function(){
